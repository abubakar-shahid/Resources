...
select Following.FollowedUserName from Following where max
(select Following.FollowedUserName, count(FollowedUserName) as Count
from Following group by FollowedUserName);